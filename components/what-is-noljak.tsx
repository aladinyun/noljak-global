...
export function WhatIsNoljak() {
  const t = useTranslations("whatIsNoljak")

  return (
    <section id="what-is-noljak" className="bg-white py-[120px] px-4">
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          <div className="bg-[#F5F0E0] rounded-2xl py-[60px] px-8 flex flex-col items-center gap-4">
            ...
            <h3 className="font-heading font-semibold text-[#0F1B3D] text-xl text-center">{t("card1Title")}</h3>
            <p className="font-sans text-[#5F6B7A] text-[15px] text-center leading-relaxed">{t("card1Desc")}</p>
          </div>
          ...
          <div className="bg-[#F5F0E0] rounded-2xl py-[60px] px-8 flex flex-col items-center gap-4">
            ...
            <h3 className="font-heading font-semibold text-[#0F1B3D] text-xl text-center">{t("card2Title")}</h3>
            <p className="font-sans text-[#5F6B7A] text-[15px] text-center leading-relaxed">{t("card2Desc")}</p>
          </div>
          ...
          <div className="bg-[#F5F0E0] rounded-2xl py-[60px] px-8 flex flex-col items-center gap-4">
            ...
            <h3 className="font-heading font-semibold text-[#0F1B3D] text-xl text-center">{t("card3Title")}</h3>
            <p className="font-sans text-[#5F6B7A] text-[15px] text-center leading-relaxed">{t("card3Desc")}</p>
          </div>
        </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 w-full">
            {countries.map((country) => (
              <div key={country.code} className="flex flex-col items-center gap-2">
                ...
                />
                <span className="font-sans text-[#5F6B7A] text-[12px] text-center">{country.label}</span>
              </div>
            ))}
          </div>
